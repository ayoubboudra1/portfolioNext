  ...
  return (
    ...
    <div className=' text-black pb-10 ' id="About">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:pt-16 lg:pb-5 ">
        <motion.h1 className="mb-4 text-4xl italic  font-extrabold tracking-tight leading-none  md:text-5xl  "
                    ref={ref}
      ...
      <motion.div 
        ...
        <div className='flex flex-col lg:flex-row lg:items-center '>
          <Image src={myInfo.myImagePath} width={600} height={600} alt="" className=' rounded-full w-40 m-auto my-5 lg:w-1/4 ' />
