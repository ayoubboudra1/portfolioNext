...
function NavBar() {
  ...
  return (
    <>
        <div className='w-screen h-16 font-bold text-white bg-black flex flex-row fixed top-0 drop-shadow-md z-40' id="navbar">
            <Link href='/' className='logo w-full flex justify-center items-center italic lg:basis-1/2  cursor-pointer '>
                <h1 className='text-2xl   '>
                    <span className='text-yellow-400 '>&lt;/</span>Ayoub_Bd<span className='text-yellow-400'>&gt;</span>    
                </h1>
            </Link>
            <div className='hidden lg:block lg:basis-2/3  '>
                <ul className='flex flex-row h-full justify-center items-center text-xl m-auto  '>
                    
                    <Link href="/"  className={router.pathname === '/'?'font-bold text-xl m-2 p-2 relative w-max two':'font-bold text-xl m-2 p-2 relative w-max one'}>
                            <p className='' >Home</p>
                            <span className="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-yellow-400"></span>
                    </Link>
                    <Link  href="/about" className={router.pathname === '/about'?'font-bold text-xl m-2 p-2 relative w-max two':'font-bold text-xl m-2 p-2 relative w-max one'}>
                            <p className=''>About</p>
                            <span className="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-yellow-400"></span>
                    </Link>
                    <Link href="/project" className={router.pathname === '/project'?'font-bold text-xl m-2 p-2 relative w-max two':'font-bold text-xl m-2 p-2 relative w-max one'}>
                            <p className='' >Projects</p>
                            <span className="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-yellow-400"></span>
                    </Link>
                    <Link href="/skills" className={router.pathname === '/skills'?'font-bold text-xl m-2 p-2 relative w-max two':'font-bold text-xl m-2 p-2 relative w-max one'}>
                            <p className='' >Skills</p>
                            <span className="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-yellow-400"></span>
                    </Link>
                    <Link href="/contact" className={router.pathname === '/contact'?'font-bold text-xl m-2 p-2 relative w-max two':'font-bold text-xl m-2 p-2 relative w-max one'}>
                            <p className='' >Contact</p>
                            <span className="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-yellow-400"></span>
                    </Link>

                    <Link href="">
                        <button className="ml-12 mr-6   rounded-xl  relative h-[45px] w-32 overflow-hidden   bg-yellow-400 pl-3 text-white  transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-white before:transition-all before:duration-500 hover:text-yellow-400  hover:before:left-0 hover:before:w-full"><span className="relative z-10">Resume</span></button>
                    </Link>
