    ...
    <div className='flex flex-col text-white  bg-black '>
        <div className=" grid lg:grid-cols-3  ">
            ...
            <div className=' my-5'>
                ...
                <div className='ml-4 mr-5'>   
                      ...
                      <div className="relative ">
                          ...
                          <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm mx-2 text-gray-900 border   bg-white   rounded-xl " placeholder="ayoub.boudra1@gmail.com" disabled={true}/>
                          <button type="button" className="text-white absolute right-2.5 bottom-2.5 bg-yellow-400 hover:scale-105   font-medium rounded-xl text-sm px-4 py-2    shadow-sm ">Copy</button>
                      </div>
              </div>
            </div>
            <div className=' my-5 cursor-pointer  '>
                ...
                <div className='email relative m-6 w-80 hover:scale-105 '>
                        <button className=" cursor-pointer  font-bold my-6 p-3 pl-12   w-full drop-shadow-lg  rounded-xl  relative   overflow-hidden   bg-yellow-400 px-3 text-white shadow-2xl ">
                            <span className="relative z-10">
                                ...
                                <svg className="fill-current w-6 h-6  " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/></svg>
                                </div>
                                Download my Resume
                            </span>
                        </button>
                ...
                <Link href='/' className='logo  w-full flex justify-center items-center italic lg:basis-1/3 mt-14 '>
