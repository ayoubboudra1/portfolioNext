  ...
  return (
    ...
    <div className="flex justify-center items-center z-0" id="Home">
          ...
          <AnimatePresence mode='popLayout'>
              <motion.h1 className="mb-4 text-4xl lg:text-6xl font-extrabold tracking-tight leading-none text-black md:text-5xl"
                          ref={ref}
              ...
              <motion.p className="mb-8 text-2xl font-normal  lg:text-4xl sm:px-16 lg:px-48 lg:my-12 text-gray-600"
              ...
              <motion.div className="flex flex-col   sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4"
                          ref={ref}
                          initial={{ y: 100, opacity: 0 }}
                          animate={{ y: 0, opacity: 1 }}
                          exit={{ y: -10, opacity: 0 }}
